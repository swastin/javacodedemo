...
<body>
	...
	<sql:setDataSource driver="com.mysql.jdbc.Driver"
		url="jdbc:mysql://localhost:3306/world" user="root" password="root"
...
<table border="1px">
		...
		<c:forEach var="country1" items="${rs1.rows}">
			<tr>
				<td><c:out value="${country1.Code}"></c:out></td>
				<td><c:out value="${country1.Name}"></c:out></td> 
				<td><c:out value="${country1.Continent}"></c:out></td>
			</tr>
		</c:forEach>
	</table>
